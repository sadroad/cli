...
impl Session {
    ...
    pub fn for_test(agent_id: &str, agent_name: &str) -> Result<Self> {
        ...
        // portable-pty falls back to HOME as the child working directory.
        // Nix builds intentionally use a nonexistent /homeless-shelter HOME,
        // so keep this fixture independent of the caller's home directory.
